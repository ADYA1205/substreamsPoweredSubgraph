...
export class Pimark_SaleCancelled {
  static encode(message: Pimark_SaleCancelled, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_SaleCancelled {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_SaleCancelled();
