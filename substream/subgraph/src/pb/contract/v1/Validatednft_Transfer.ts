...
export class Validatednft_Transfer {
  static encode(message: Validatednft_Transfer, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_Transfer {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_Transfer();
