...
export class Pimark_AcceptSwapRequestCall {
  static encode(message: Pimark_AcceptSwapRequestCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_AcceptSwapRequestCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_AcceptSwapRequestCall();
