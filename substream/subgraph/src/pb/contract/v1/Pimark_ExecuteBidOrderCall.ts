...
export class Pimark_ExecuteBidOrderCall {
  static encode(message: Pimark_ExecuteBidOrderCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(50);
    writer.string(message.uSaleId);

    writer.uint32(58);
    writer.string(message.uBidOrderId);
  }

  static decode(reader: Reader, length: i32): Pimark_ExecuteBidOrderCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_ExecuteBidOrderCall();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          message.uSaleId = reader.string();
          break;

        case 7:
          message.uBidOrderId = reader.string();
          break;
  ...
  constructor(
    ...
    this.uSaleId = uSaleId;
    this.uBidOrderId = uBidOrderId;
  }
}
