...
export class Pinft_Upgraded2 {
  static encode(message: Pinft_Upgraded2, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_Upgraded2 {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_Upgraded2();
