...
export class Pinft_AddTrustedForwarderCall {
  static encode(message: Pinft_AddTrustedForwarderCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_AddTrustedForwarderCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_AddTrustedForwarderCall();
