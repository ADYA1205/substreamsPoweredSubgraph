...
export class Validatednft_Unpaused {
  static encode(message: Validatednft_Unpaused, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_Unpaused {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_Unpaused();
