...
export class Pimeth_LazyAddValidatorCall {
  static encode(message: Pimeth_LazyAddValidatorCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(66);
    writer.bytes(message.uValidator);
  }

  static decode(reader: Reader, length: i32): Pimeth_LazyAddValidatorCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_LazyAddValidatorCall();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          message.uValidator = reader.bytes();
          break;
  ...
  constructor(
    ...
    uTokenId: string = "",
    uValidator: Uint8Array = new Uint8Array(0)
  ) {
