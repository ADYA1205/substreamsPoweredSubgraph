...
export class Validatednft_OwnershipTransferred {
  static encode(
    message: Validatednft_OwnershipTransferred,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_OwnershipTransferred {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_OwnershipTransferred();
