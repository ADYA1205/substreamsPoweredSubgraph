...
export class Pimeth_PauseCall {
  static encode(message: Pimeth_PauseCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_PauseCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_PauseCall();
