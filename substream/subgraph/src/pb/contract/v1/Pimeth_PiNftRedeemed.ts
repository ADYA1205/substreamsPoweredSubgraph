...
export class Pimeth_PiNftRedeemed {
  static encode(message: Pimeth_PiNftRedeemed, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_PiNftRedeemed {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_PiNftRedeemed();
