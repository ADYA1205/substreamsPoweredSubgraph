...
export class Pimeth_AddValidatorCall {
  static encode(message: Pimeth_AddValidatorCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_AddValidatorCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_AddValidatorCall();
