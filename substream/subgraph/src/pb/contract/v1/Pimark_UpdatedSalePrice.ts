...
export class Pimark_UpdatedSalePrice {
  static encode(message: Pimark_UpdatedSalePrice, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(58);
    writer.string(message.duration);
  }

  static decode(reader: Reader, length: i32): Pimark_UpdatedSalePrice {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_UpdatedSalePrice();
