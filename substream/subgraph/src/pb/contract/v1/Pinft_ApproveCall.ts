...
export class Pinft_ApproveCall {
  static encode(message: Pinft_ApproveCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_ApproveCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_ApproveCall();
