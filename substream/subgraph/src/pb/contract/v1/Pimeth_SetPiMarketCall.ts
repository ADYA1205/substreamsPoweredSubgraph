...
export class Pimeth_SetPiMarketCall {
  static encode(message: Pimeth_SetPiMarketCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(50);
    writer.bytes(message.uPiMarket);
  }

  static decode(reader: Reader, length: i32): Pimeth_SetPiMarketCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_SetPiMarketCall();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          message.uPiMarket = reader.bytes();
          break;
  ...
  constructor(
    ...
    uPiMarket: Uint8Array = new Uint8Array(0)
  ) {
