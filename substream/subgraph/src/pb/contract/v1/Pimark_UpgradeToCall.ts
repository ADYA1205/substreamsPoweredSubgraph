...
export class Pimark_UpgradeToCall {
  static encode(message: Pimark_UpgradeToCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_UpgradeToCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_UpgradeToCall();
