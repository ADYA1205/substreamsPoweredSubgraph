...
export class Pimark_Paused {
  static encode(message: Pimark_Paused, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_Paused {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_Paused();
