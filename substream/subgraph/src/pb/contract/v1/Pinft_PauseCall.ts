...
export class Pinft_PauseCall {
  static encode(message: Pinft_PauseCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_PauseCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_PauseCall();
