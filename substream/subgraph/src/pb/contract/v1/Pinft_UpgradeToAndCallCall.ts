...
export class Pinft_UpgradeToAndCallCall {
  static encode(message: Pinft_UpgradeToAndCallCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_UpgradeToAndCallCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_UpgradeToAndCallCall();
