...
export class Validatednft_UnpauseCall {
  static encode(message: Validatednft_UnpauseCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_UnpauseCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_UnpauseCall();
