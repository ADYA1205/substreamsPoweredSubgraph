...
export class Pinft_OwnershipTransferred {
  static encode(message: Pinft_OwnershipTransferred, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_OwnershipTransferred {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_OwnershipTransferred();
