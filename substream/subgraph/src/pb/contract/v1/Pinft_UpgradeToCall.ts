...
export class Pinft_UpgradeToCall {
  static encode(message: Pinft_UpgradeToCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_UpgradeToCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_UpgradeToCall();
