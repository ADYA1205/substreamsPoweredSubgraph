...
export class Lendborrow_BeaconUpgraded {
  static encode(message: Lendborrow_BeaconUpgraded, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Lendborrow_BeaconUpgraded {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Lendborrow_BeaconUpgraded();
