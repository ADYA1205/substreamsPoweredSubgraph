...
export class Pinft_Initialized {
  static encode(message: Pinft_Initialized, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_Initialized {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_Initialized();
