...
export class Pimark_BeaconUpgraded1 {
  static encode(message: Pimark_BeaconUpgraded1, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_BeaconUpgraded1 {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_BeaconUpgraded1();
