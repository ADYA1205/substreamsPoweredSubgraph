...
export class Pimark_TransferOwnershipCall {
  static encode(message: Pimark_TransferOwnershipCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_TransferOwnershipCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_TransferOwnershipCall();
