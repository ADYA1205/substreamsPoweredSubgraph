...
export class Pimeth_RemoveTrustedForwarderCall {
  static encode(
    message: Pimeth_RemoveTrustedForwarderCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Pimeth_RemoveTrustedForwarderCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_RemoveTrustedForwarderCall();
