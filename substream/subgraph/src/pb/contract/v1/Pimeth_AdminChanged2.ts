...
export class Pimeth_AdminChanged2 {
  static encode(message: Pimeth_AdminChanged2, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_AdminChanged2 {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_AdminChanged2();
