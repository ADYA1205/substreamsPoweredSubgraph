...
export class Validatednft_ApproveCall {
  static encode(message: Validatednft_ApproveCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_ApproveCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_ApproveCall();
