...
export class Pinft_UnpauseCall {
  static encode(message: Pinft_UnpauseCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_UnpauseCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_UnpauseCall();
