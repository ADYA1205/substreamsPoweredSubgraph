...
export class Acofee_SetAconomyNftLendBorrowFee {
  static encode(
    message: Acofee_SetAconomyNftLendBorrowFee,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Acofee_SetAconomyNftLendBorrowFee {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Acofee_SetAconomyNftLendBorrowFee();
