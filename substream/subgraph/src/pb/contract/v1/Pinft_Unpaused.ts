...
export class Pinft_Unpaused {
  static encode(message: Pinft_Unpaused, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_Unpaused {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_Unpaused();
