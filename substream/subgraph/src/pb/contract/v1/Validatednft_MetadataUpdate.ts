...
export class Validatednft_MetadataUpdate {
  static encode(message: Validatednft_MetadataUpdate, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_MetadataUpdate {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_MetadataUpdate();
