...
export class Acofee_SetAconomyPoolFeeCall {
  static encode(message: Acofee_SetAconomyPoolFeeCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Acofee_SetAconomyPoolFeeCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Acofee_SetAconomyPoolFeeCall();
