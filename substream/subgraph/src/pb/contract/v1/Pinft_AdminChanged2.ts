...
export class Pinft_AdminChanged2 {
  static encode(message: Pinft_AdminChanged2, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_AdminChanged2 {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_AdminChanged2();
