...
export class Pimeth_Paused {
  static encode(message: Pimeth_Paused, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_Paused {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_Paused();
