...
export class Validatednft_PauseCall {
  static encode(message: Validatednft_PauseCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_PauseCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_PauseCall();
