...
export class Pinft_Paused {
  static encode(message: Pinft_Paused, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_Paused {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_Paused();
