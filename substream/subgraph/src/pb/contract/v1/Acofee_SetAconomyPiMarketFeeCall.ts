...
export class Acofee_SetAconomyPiMarketFeeCall {
  static encode(
    message: Acofee_SetAconomyPiMarketFeeCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Acofee_SetAconomyPiMarketFeeCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Acofee_SetAconomyPiMarketFeeCall();
