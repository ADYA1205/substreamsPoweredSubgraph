...
export class Lendborrow_Upgraded {
  static encode(message: Lendborrow_Upgraded, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Lendborrow_Upgraded {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Lendborrow_Upgraded();
