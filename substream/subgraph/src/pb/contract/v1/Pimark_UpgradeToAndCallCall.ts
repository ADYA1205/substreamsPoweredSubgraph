...
export class Pimark_UpgradeToAndCallCall {
  static encode(message: Pimark_UpgradeToAndCallCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_UpgradeToAndCallCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_UpgradeToAndCallCall();
