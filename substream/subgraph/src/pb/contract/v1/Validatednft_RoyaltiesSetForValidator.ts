...
export class Validatednft_RoyaltiesSetForValidator {
  static encode(
    message: Validatednft_RoyaltiesSetForValidator,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_RoyaltiesSetForValidator {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_RoyaltiesSetForValidator();
