...
export class Pimark_BidEvent {
  static encode(message: Pimark_BidEvent, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(80);
    writer.bool(message.bidCreated);
  }

  static decode(reader: Reader, length: i32): Pimark_BidEvent {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_BidEvent();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          message.bidCreated = reader.bool();
          break;
