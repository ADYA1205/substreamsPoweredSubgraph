...
export class Acofee_TransferOwnershipCall {
  static encode(message: Acofee_TransferOwnershipCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Acofee_TransferOwnershipCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Acofee_TransferOwnershipCall();
