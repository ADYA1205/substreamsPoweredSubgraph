...
export class Pimark_CancelSaleCall {
  static encode(message: Pimark_CancelSaleCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_CancelSaleCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_CancelSaleCall();
