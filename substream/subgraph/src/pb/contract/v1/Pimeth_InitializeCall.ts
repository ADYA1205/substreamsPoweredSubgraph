...
export class Pimeth_InitializeCall {
  static encode(message: Pimeth_InitializeCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(50);
    writer.bytes(message.trustedForwarder);
  }

  static decode(reader: Reader, length: i32): Pimeth_InitializeCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_InitializeCall();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          message.trustedForwarder = reader.bytes();
          break;
  ...
  constructor(
    ...
    trustedForwarder: Uint8Array = new Uint8Array(0)
  ) {
