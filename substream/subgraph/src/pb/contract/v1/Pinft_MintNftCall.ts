...
export class Pinft_MintNftCall {
  static encode(message: Pinft_MintNftCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_MintNftCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_MintNftCall();
