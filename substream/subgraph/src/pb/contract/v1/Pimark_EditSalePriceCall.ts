...
export class Pimark_EditSalePriceCall {
  static encode(message: Pimark_EditSalePriceCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(66);
    writer.string(message.uDuration);
  }

  static decode(reader: Reader, length: i32): Pimark_EditSalePriceCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_EditSalePriceCall();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          message.uDuration = reader.string();
          break;
