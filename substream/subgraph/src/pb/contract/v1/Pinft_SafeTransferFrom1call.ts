...
export class Pinft_SafeTransferFrom1call {
  static encode(message: Pinft_SafeTransferFrom1call, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_SafeTransferFrom1call {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_SafeTransferFrom1call();
