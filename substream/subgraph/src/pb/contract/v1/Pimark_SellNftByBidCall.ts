...
export class Pimark_SellNftByBidCall {
  static encode(message: Pimark_SellNftByBidCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(74);
    writer.string(message.uBidTime);

    writer.uint32(82);
    writer.bytes(message.uCurrency);
  }

  static decode(reader: Reader, length: i32): Pimark_SellNftByBidCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_SellNftByBidCall();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          message.uBidTime = reader.string();
          break;
