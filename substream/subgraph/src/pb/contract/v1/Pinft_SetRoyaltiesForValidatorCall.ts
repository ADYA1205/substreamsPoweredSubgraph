...
export class Pinft_SetRoyaltiesForValidatorCall {
  static encode(
    message: Pinft_SetRoyaltiesForValidatorCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Pinft_SetRoyaltiesForValidatorCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_SetRoyaltiesForValidatorCall();
