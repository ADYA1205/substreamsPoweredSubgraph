...
export class Pinft_DeleteNftCall {
  static encode(message: Pinft_DeleteNftCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_DeleteNftCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_DeleteNftCall();
