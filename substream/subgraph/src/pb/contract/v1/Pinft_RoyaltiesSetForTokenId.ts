...
export class Pinft_RoyaltiesSetForTokenId {
  static encode(message: Pinft_RoyaltiesSetForTokenId, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_RoyaltiesSetForTokenId {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_RoyaltiesSetForTokenId();
