...
export class Pimark_SwapAccepted {
  static encode(message: Pimark_SwapAccepted, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_SwapAccepted {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_SwapAccepted();
