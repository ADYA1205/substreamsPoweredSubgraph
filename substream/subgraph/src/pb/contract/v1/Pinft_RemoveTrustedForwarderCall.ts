...
export class Pinft_RemoveTrustedForwarderCall {
  static encode(
    message: Pinft_RemoveTrustedForwarderCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_RemoveTrustedForwarderCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_RemoveTrustedForwarderCall();
