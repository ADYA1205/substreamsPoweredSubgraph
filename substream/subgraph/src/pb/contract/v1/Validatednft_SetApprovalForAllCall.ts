...
export class Validatednft_SetApprovalForAllCall {
  static encode(
    message: Validatednft_SetApprovalForAllCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_SetApprovalForAllCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_SetApprovalForAllCall();
