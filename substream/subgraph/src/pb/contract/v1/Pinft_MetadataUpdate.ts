...
export class Pinft_MetadataUpdate {
  static encode(message: Pinft_MetadataUpdate, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_MetadataUpdate {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_MetadataUpdate();
