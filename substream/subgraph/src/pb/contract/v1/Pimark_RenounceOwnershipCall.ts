...
export class Pimark_RenounceOwnershipCall {
  static encode(message: Pimark_RenounceOwnershipCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_RenounceOwnershipCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_RenounceOwnershipCall();
