...
export class Pinft_DeleteValidatorRoyaltiesCall {
  static encode(
    message: Pinft_DeleteValidatorRoyaltiesCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Pinft_DeleteValidatorRoyaltiesCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_DeleteValidatorRoyaltiesCall();
