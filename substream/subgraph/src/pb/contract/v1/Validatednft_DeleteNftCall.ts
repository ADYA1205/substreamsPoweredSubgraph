...
export class Validatednft_DeleteNftCall {
  static encode(message: Validatednft_DeleteNftCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_DeleteNftCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_DeleteNftCall();
