...
export class Pimeth_AdminChanged1 {
  static encode(message: Pimeth_AdminChanged1, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_AdminChanged1 {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_AdminChanged1();
