...
export class Validatednft_OnErc721ReceivedCall {
  static encode(
    message: Validatednft_OnErc721ReceivedCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_OnErc721ReceivedCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_OnErc721ReceivedCall();
