...
export class Pimeth_AddTrustedForwarderCall {
  static encode(message: Pimeth_AddTrustedForwarderCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(50);
    writer.bytes(message.uTf);
  }

  static decode(reader: Reader, length: i32): Pimeth_AddTrustedForwarderCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_AddTrustedForwarderCall();
  ...
  constructor(
    ...
    uTf: Uint8Array = new Uint8Array(0)
  ) {
