...
export class Validatednft_SafeTransferFrom2call {
  static encode(
    message: Validatednft_SafeTransferFrom2call,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_SafeTransferFrom2call {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_SafeTransferFrom2call();
