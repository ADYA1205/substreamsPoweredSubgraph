...
export class Pimark_PauseCall {
  static encode(message: Pimark_PauseCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_PauseCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_PauseCall();
