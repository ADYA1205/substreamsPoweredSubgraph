...
export class Pimeth_UnpauseCall {
  static encode(message: Pimeth_UnpauseCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_UnpauseCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_UnpauseCall();
