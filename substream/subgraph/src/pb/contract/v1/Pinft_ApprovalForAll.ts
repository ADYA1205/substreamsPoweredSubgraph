...
export class Pinft_ApprovalForAll {
  static encode(message: Pinft_ApprovalForAll, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_ApprovalForAll {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_ApprovalForAll();
