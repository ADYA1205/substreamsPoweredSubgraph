...
export class Validatednft_BatchMetadataUpdate {
  static encode(
    message: Validatednft_BatchMetadataUpdate,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_BatchMetadataUpdate {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_BatchMetadataUpdate();
