...
export class Validatednft_AdminChanged1 {
  static encode(message: Validatednft_AdminChanged1, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_AdminChanged1 {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_AdminChanged1();
