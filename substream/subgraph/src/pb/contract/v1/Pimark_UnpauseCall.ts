...
export class Pimark_UnpauseCall {
  static encode(message: Pimark_UnpauseCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_UnpauseCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_UnpauseCall();
