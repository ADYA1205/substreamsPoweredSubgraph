...
export class Validatednft_TransferFromCall {
  static encode(message: Validatednft_TransferFromCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_TransferFromCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_TransferFromCall();
