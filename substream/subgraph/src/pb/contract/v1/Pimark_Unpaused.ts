...
export class Pimark_Unpaused {
  static encode(message: Pimark_Unpaused, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_Unpaused {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_Unpaused();
