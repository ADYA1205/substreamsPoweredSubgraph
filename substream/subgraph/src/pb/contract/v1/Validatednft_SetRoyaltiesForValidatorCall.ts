...
export class Validatednft_SetRoyaltiesForValidatorCall {
  static encode(
    message: Validatednft_SetRoyaltiesForValidatorCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_SetRoyaltiesForValidatorCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_SetRoyaltiesForValidatorCall();
