...
export class Validatednft_RenounceOwnershipCall {
  static encode(
    message: Validatednft_RenounceOwnershipCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_RenounceOwnershipCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_RenounceOwnershipCall();
