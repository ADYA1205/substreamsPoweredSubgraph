...
export class Pimeth_UpgradeToAndCallCall {
  static encode(message: Pimeth_UpgradeToAndCallCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_UpgradeToAndCallCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_UpgradeToAndCallCall();
