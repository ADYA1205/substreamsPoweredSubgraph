...
export class Pinft_Transfer {
  static encode(message: Pinft_Transfer, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_Transfer {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_Transfer();
