...
export class Pinft_RenounceOwnershipCall {
  static encode(message: Pinft_RenounceOwnershipCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_RenounceOwnershipCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_RenounceOwnershipCall();
