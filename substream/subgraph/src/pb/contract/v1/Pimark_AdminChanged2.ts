...
export class Pimark_AdminChanged2 {
  static encode(message: Pimark_AdminChanged2, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_AdminChanged2 {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_AdminChanged2();
