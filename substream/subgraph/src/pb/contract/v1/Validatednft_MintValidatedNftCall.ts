...
export class Validatednft_MintValidatedNftCall {
  static encode(
    message: Validatednft_MintValidatedNftCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_MintValidatedNftCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_MintValidatedNftCall();
