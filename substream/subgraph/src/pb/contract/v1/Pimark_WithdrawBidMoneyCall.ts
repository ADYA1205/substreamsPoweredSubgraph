...
export class Pimark_WithdrawBidMoneyCall {
  static encode(message: Pimark_WithdrawBidMoneyCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(58);
    writer.string(message.uBidId);
  }

  static decode(reader: Reader, length: i32): Pimark_WithdrawBidMoneyCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_WithdrawBidMoneyCall();
