...
export class Pimark_NftBought {
  static encode(message: Pimark_NftBought, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_NftBought {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_NftBought();
