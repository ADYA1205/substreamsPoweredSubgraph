...
export class Pinft_SetApprovalForAllCall {
  static encode(message: Pinft_SetApprovalForAllCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_SetApprovalForAllCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_SetApprovalForAllCall();
