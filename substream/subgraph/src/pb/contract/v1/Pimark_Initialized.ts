...
export class Pimark_Initialized {
  static encode(message: Pimark_Initialized, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_Initialized {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_Initialized();
