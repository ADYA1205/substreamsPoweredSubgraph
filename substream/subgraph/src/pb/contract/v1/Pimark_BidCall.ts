...
export class Pimark_BidCall {
  static encode(message: Pimark_BidCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(58);
    writer.string(message.uBidPrice);
  }

  static decode(reader: Reader, length: i32): Pimark_BidCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_BidCall();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          message.uBidPrice = reader.string();
          break;
