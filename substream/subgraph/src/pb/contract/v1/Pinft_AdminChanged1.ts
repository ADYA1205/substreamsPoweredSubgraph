...
export class Pinft_AdminChanged1 {
  static encode(message: Pinft_AdminChanged1, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_AdminChanged1 {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_AdminChanged1();
