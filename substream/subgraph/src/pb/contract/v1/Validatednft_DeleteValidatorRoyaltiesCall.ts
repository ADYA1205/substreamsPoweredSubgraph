...
export class Validatednft_DeleteValidatorRoyaltiesCall {
  static encode(
    message: Validatednft_DeleteValidatorRoyaltiesCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_DeleteValidatorRoyaltiesCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_DeleteValidatorRoyaltiesCall();
