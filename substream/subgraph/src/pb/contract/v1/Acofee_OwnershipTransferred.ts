...
export class Acofee_OwnershipTransferred {
  static encode(message: Acofee_OwnershipTransferred, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Acofee_OwnershipTransferred {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Acofee_OwnershipTransferred();
