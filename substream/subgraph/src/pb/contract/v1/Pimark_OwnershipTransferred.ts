...
export class Pimark_OwnershipTransferred {
  static encode(message: Pimark_OwnershipTransferred, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_OwnershipTransferred {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_OwnershipTransferred();
