...
export class Validatednft_TokenMinted {
  static encode(message: Validatednft_TokenMinted, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_TokenMinted {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_TokenMinted();
