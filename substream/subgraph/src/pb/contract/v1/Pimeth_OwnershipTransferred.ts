...
export class Pimeth_OwnershipTransferred {
  static encode(message: Pimeth_OwnershipTransferred, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_OwnershipTransferred {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_OwnershipTransferred();
