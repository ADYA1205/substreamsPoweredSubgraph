...
export class Pimeth_UpgradeToCall {
  static encode(message: Pimeth_UpgradeToCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_UpgradeToCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_UpgradeToCall();
