...
export class Acofee_SetAconomyNftLendBorrowFeeCall {
  static encode(
    message: Acofee_SetAconomyNftLendBorrowFeeCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Acofee_SetAconomyNftLendBorrowFeeCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Acofee_SetAconomyNftLendBorrowFeeCall();
