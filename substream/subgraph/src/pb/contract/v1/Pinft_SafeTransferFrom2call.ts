...
export class Pinft_SafeTransferFrom2call {
  static encode(message: Pinft_SafeTransferFrom2call, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_SafeTransferFrom2call {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_SafeTransferFrom2call();
