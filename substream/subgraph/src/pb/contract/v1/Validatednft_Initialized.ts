...
export class Validatednft_Initialized {
  static encode(message: Validatednft_Initialized, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_Initialized {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_Initialized();
