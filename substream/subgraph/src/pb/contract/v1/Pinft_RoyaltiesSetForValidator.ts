...
export class Pinft_RoyaltiesSetForValidator {
  static encode(message: Pinft_RoyaltiesSetForValidator, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_RoyaltiesSetForValidator {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_RoyaltiesSetForValidator();
