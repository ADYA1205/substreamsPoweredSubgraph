...
export class Pinft_TransferOwnershipCall {
  static encode(message: Pinft_TransferOwnershipCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_TransferOwnershipCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_TransferOwnershipCall();
