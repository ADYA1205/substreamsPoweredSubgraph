...
export class Pimeth_RenounceOwnershipCall {
  static encode(message: Pimeth_RenounceOwnershipCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_RenounceOwnershipCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_RenounceOwnershipCall();
