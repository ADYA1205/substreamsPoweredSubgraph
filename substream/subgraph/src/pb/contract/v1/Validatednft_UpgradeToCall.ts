...
export class Validatednft_UpgradeToCall {
  static encode(message: Validatednft_UpgradeToCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_UpgradeToCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_UpgradeToCall();
