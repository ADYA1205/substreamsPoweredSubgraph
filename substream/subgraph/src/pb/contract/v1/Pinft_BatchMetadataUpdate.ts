...
export class Pinft_BatchMetadataUpdate {
  static encode(message: Pinft_BatchMetadataUpdate, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(42);
    writer.string(message.uFromTokenId);

    writer.uint32(50);
    writer.string(message.uToTokenId);
  }

  static decode(reader: Reader, length: i32): Pinft_BatchMetadataUpdate {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_BatchMetadataUpdate();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          message.uFromTokenId = reader.string();
          break;

        case 6:
          message.uToTokenId = reader.string();
          break;
  ...
  constructor(
    ...
    this.uFromTokenId = uFromTokenId;
    this.uToTokenId = uToTokenId;
  }
}
