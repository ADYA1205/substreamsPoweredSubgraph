...
export class Validatednft_TransferOwnershipCall {
  static encode(
    message: Validatednft_TransferOwnershipCall,
    writer: Writer
  ): void {
    writer.uint32(10);
  ...
  static decode(
    reader: Reader,
    length: i32
  ): Validatednft_TransferOwnershipCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_TransferOwnershipCall();
