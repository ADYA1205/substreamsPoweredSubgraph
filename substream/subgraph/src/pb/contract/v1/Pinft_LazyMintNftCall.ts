...
export class Pinft_LazyMintNftCall {
  static encode(message: Pinft_LazyMintNftCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_LazyMintNftCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_LazyMintNftCall();
