...
export class Lendborrow_AdminChanged {
  static encode(message: Lendborrow_AdminChanged, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Lendborrow_AdminChanged {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Lendborrow_AdminChanged();
