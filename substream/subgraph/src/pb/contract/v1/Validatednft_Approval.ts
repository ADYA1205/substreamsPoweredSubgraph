...
export class Validatednft_Approval {
  static encode(message: Validatednft_Approval, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Validatednft_Approval {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Validatednft_Approval();
