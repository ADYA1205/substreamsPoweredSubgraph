...
export class Acofee_RenounceOwnershipCall {
  static encode(message: Acofee_RenounceOwnershipCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Acofee_RenounceOwnershipCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Acofee_RenounceOwnershipCall();
