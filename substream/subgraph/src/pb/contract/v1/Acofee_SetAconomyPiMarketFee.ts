...
export class Acofee_SetAconomyPiMarketFee {
  static encode(message: Acofee_SetAconomyPiMarketFee, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(40);
    writer.uint64(message.newFee);

    writer.uint32(48);
    writer.uint64(message.oldFee);
  }

  static decode(reader: Reader, length: i32): Acofee_SetAconomyPiMarketFee {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Acofee_SetAconomyPiMarketFee();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          message.newFee = reader.uint64();
          break;

        case 6:
          message.oldFee = reader.uint64();
          break;
