...
export class Pinft_Approval {
  static encode(message: Pinft_Approval, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pinft_Approval {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pinft_Approval();
