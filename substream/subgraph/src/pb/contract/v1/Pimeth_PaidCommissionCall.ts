...
export class Pimeth_PaidCommissionCall {
  static encode(message: Pimeth_PaidCommissionCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(50);
    writer.bytes(message.uCollection);

    writer.uint32(58);
    writer.string(message.uTokenId);
  }

  static decode(reader: Reader, length: i32): Pimeth_PaidCommissionCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_PaidCommissionCall();
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          message.uCollection = reader.bytes();
          break;
  ...
  constructor(
    ...
    uCollection: Uint8Array = new Uint8Array(0),
    uTokenId: string = ""
  ) {
