...
export class Pimeth_RepayCall {
  static encode(message: Pimeth_RepayCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_RepayCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_RepayCall();
