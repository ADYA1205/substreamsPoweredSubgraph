...
export class Pimeth_ValidatorAdded {
  static encode(message: Pimeth_ValidatorAdded, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_ValidatorAdded {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_ValidatorAdded();
