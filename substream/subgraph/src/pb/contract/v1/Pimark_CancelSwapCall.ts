...
export class Pimark_CancelSwapCall {
  static encode(message: Pimark_CancelSwapCall, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(50);
    writer.string(message.uSwapId);
  }

  static decode(reader: Reader, length: i32): Pimark_CancelSwapCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_CancelSwapCall();
