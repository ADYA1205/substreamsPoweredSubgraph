...
export class Acofee_SetAconomyPoolFee {
  static encode(message: Acofee_SetAconomyPoolFee, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Acofee_SetAconomyPoolFee {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Acofee_SetAconomyPoolFee();
