...
export class Pimeth_Unpaused {
  static encode(message: Pimeth_Unpaused, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_Unpaused {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_Unpaused();
