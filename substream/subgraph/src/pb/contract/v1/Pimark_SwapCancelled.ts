...
export class Pimark_SwapCancelled {
  static encode(message: Pimark_SwapCancelled, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_SwapCancelled {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_SwapCancelled();
