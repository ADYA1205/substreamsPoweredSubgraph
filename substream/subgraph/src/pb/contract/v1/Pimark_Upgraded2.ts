...
export class Pimark_Upgraded2 {
  static encode(message: Pimark_Upgraded2, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_Upgraded2 {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_Upgraded2();
