...
export class Pimark_BuyNftCall {
  static encode(message: Pimark_BuyNftCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimark_BuyNftCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimark_BuyNftCall();
