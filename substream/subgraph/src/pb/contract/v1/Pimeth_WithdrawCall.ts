...
export class Pimeth_WithdrawCall {
  static encode(message: Pimeth_WithdrawCall, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Pimeth_WithdrawCall {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Pimeth_WithdrawCall();
