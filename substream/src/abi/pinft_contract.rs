...
pub mod functions {
    ...
    pub struct AddTrustedForwarder {
        pub u_tf: Vec<u8>,
    }
    impl AddTrustedForwarder {
        const METHOD_ID: [u8; 4] = [38u8, 208u8, 6u8, 104u8];
        pub fn decode(
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::Address(ethabi::Address::from_slice(&self.u_tf))],
            );
    ...
    impl substreams_ethereum::Function for AddTrustedForwarder {
        const NAME: &'static str = "addTrustedForwarder";
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DeleteNft {
        pub u_token_id: substreams::scalar::BigInt,
    }
    impl DeleteNft {
        const METHOD_ID: [u8; 4] = [246u8, 135u8, 237u8, 87u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for DeleteNft {
        const NAME: &'static str = "deleteNFT";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DeleteValidatorRoyalties {
        pub u_token_id: substreams::scalar::BigInt,
    }
    impl DeleteValidatorRoyalties {
        const METHOD_ID: [u8; 4] = [57u8, 22u8, 1u8, 220u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for DeleteValidatorRoyalties {
        const NAME: &'static str = "deleteValidatorRoyalties";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl GetRoyalties {
        const METHOD_ID: [u8; 4] = [187u8, 59u8, 175u8, 214u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GetRoyalties {
        const NAME: &'static str = "getRoyalties";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetValidatorRoyalties {
        pub u_token_id: substreams::scalar::BigInt,
    }
    impl GetValidatorRoyalties {
        const METHOD_ID: [u8; 4] = [2u8, 180u8, 33u8, 65u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GetValidatorRoyalties {
        const NAME: &'static str = "getValidatorRoyalties";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct Initialize {
        pub u_name: String,
        pub u_symbol: String,
        pub u_pi_nft_methods_address: Vec<u8>,
        pub tf_gelato: Vec<u8>,
    }
    impl Initialize {
        const METHOD_ID: [u8; 4] = [143u8, 21u8, 180u8, 20u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            Ok(Self {
                ...
                u_symbol: values
                    ...
                    .into_string()
                    .expect(INTERNAL_ERR),
                u_pi_nft_methods_address: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
            ...
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_pi_nft_methods_address),
                    ),
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.tf_gelato)),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct LazyMintNft {
        pub u_to: Vec<u8>,
        pub u_uri: String,
        pub royalties: Vec<(Vec<u8>, substreams::scalar::BigInt)>,
    }
    impl LazyMintNft {
        const METHOD_ID: [u8; 4] = [43u8, 107u8, 209u8, 108u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for LazyMintNft {
        const NAME: &'static str = "lazyMintNFT";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl MintNft {
        const METHOD_ID: [u8; 4] = [238u8, 83u8, 182u8, 169u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for MintNft {
        const NAME: &'static str = "mintNFT";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MintNft {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PiNftMethodsAddress {}
    impl PiNftMethodsAddress {
        const METHOD_ID: [u8; 4] = [224u8, 23u8, 121u8, 52u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for PiNftMethodsAddress {
        const NAME: &'static str = "piNFTMethodsAddress";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for PiNftMethodsAddress {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RemoveTrustedForwarder {
        pub u_tf: Vec<u8>,
    }
    impl RemoveTrustedForwarder {
        const METHOD_ID: [u8; 4] = [55u8, 81u8, 216u8, 156u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for RemoveTrustedForwarder {
        const NAME: &'static str = "removeTrustedForwarder";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetRoyaltiesForValidator {
        pub u_token_id: substreams::scalar::BigInt,
        pub u_commission: substreams::scalar::BigInt,
        pub royalties: Vec<(Vec<u8>, substreams::scalar::BigInt)>,
    }
    impl SetRoyaltiesForValidator {
        const METHOD_ID: [u8; 4] = [69u8, 145u8, 63u8, 233u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_commission.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for SetRoyaltiesForValidator {
        const NAME: &'static str = "setRoyaltiesForValidator";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct TrustedForwarders {
        pub param0: Vec<u8>,
    }
    impl TrustedForwarders {
        const METHOD_ID: [u8; 4] = [84u8, 119u8, 107u8, 185u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for TrustedForwarders {
        const NAME: &'static str = "trustedForwarders";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for TrustedForwarders {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RoyaltiesSetForTokenId {
        pub token_id: substreams::scalar::BigInt,
        pub royalties: Vec<(Vec<u8>, substreams::scalar::BigInt)>,
    }
    impl RoyaltiesSetForTokenId {
        const TOPIC_ID: [u8; 32] = [
            226u8,
            52u8,
            37u8,
    ...
    impl substreams_ethereum::Event for RoyaltiesSetForTokenId {
        const NAME: &'static str = "RoyaltiesSetForTokenId";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RoyaltiesSetForValidator {
        pub token_id: substreams::scalar::BigInt,
        pub royalties: Vec<(Vec<u8>, substreams::scalar::BigInt)>,
    }
    impl RoyaltiesSetForValidator {
        const TOPIC_ID: [u8; 32] = [
            77u8,
            161u8,
            134u8,
    ...
    impl substreams_ethereum::Event for RoyaltiesSetForValidator {
        const NAME: &'static str = "RoyaltiesSetForValidator";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
