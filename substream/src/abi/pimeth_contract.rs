...
pub mod functions {
    ...
    impl AddErc20 {
        const METHOD_ID: [u8; 4] = [12u8, 199u8, 192u8, 42u8];
        pub fn decode(
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_erc20_contract),
                    ),
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
    ...
    impl substreams_ethereum::Function for AddErc20 {
        const NAME: &'static str = "addERC20";
    ...
    pub struct AddValidator {
        pub u_collection_address: Vec<u8>,
        pub u_token_id: substreams::scalar::BigInt,
        pub u_validator: Vec<u8>,
    }
    impl AddValidator {
        const METHOD_ID: [u8; 4] = [97u8, 116u8, 107u8, 146u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_validator),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl substreams_ethereum::Function for AddValidator {
        const NAME: &'static str = "addValidator";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl ApprovedValidator {
        const METHOD_ID: [u8; 4] = [115u8, 128u8, 135u8, 145u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for ApprovedValidator {
        const NAME: &'static str = "approvedValidator";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for ApprovedValidator {
    ...
    impl Initialize {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.trusted_forwarder),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct LazyAddValidator {
        pub u_collection_address: Vec<u8>,
        pub u_token_id: substreams::scalar::BigInt,
        pub u_validator: Vec<u8>,
    }
    impl LazyAddValidator {
        const METHOD_ID: [u8; 4] = [42u8, 55u8, 120u8, 250u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for LazyAddValidator {
        const NAME: &'static str = "lazyAddValidator";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl NfTowner {
        const METHOD_ID: [u8; 4] = [167u8, 174u8, 214u8, 5u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for NfTowner {
        const NAME: &'static str = "NFTowner";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for NfTowner {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    pub struct PaidCommission {
        pub u_collection: Vec<u8>,
        pub u_token_id: substreams::scalar::BigInt,
    }
    impl PaidCommission {
        const METHOD_ID: [u8; 4] = [228u8, 95u8, 255u8, 2u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_collection),
                    ),
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.u_token_id.clone().to_bytes_be() {
    ...
    impl substreams_ethereum::Function for PaidCommission {
        const NAME: &'static str = "paidCommission";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PiMarketAddress {}
    impl PiMarketAddress {
        const METHOD_ID: [u8; 4] = [55u8, 6u8, 93u8, 105u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for PiMarketAddress {
        const NAME: &'static str = "piMarketAddress";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for PiMarketAddress {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RedeemOrBurnPiNft {
        pub u_collection_address: Vec<u8>,
        pub u_token_id: substreams::scalar::BigInt,
        pub u_nft_receiver: Vec<u8>,
        pub u_erc20_receiver: Vec<u8>,
        pub u_erc20_contract: Vec<u8>,
        pub burn_nft: bool,
    }
    impl RedeemOrBurnPiNft {
        const METHOD_ID: [u8; 4] = [246u8, 217u8, 108u8, 187u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_nft_receiver),
                    ),
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_erc20_receiver),
                    ),
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_erc20_contract),
                    ),
                    ethabi::Token::Bool(self.burn_nft.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl substreams_ethereum::Function for RedeemOrBurnPiNft {
        const NAME: &'static str = "redeemOrBurnPiNFT";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl Repay {
        const METHOD_ID: [u8; 4] = [215u8, 174u8, 250u8, 69u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetPiMarket {
        pub u_pi_market: Vec<u8>,
    }
    impl SetPiMarket {
        const METHOD_ID: [u8; 4] = [47u8, 147u8, 113u8, 58u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::Address(ethabi::Address::from_slice(&self.u_pi_market))],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::Function for SetPiMarket {
        const NAME: &'static str = "setPiMarket";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ValidatorCommissions {
        pub param0: Vec<u8>,
        pub param1: substreams::scalar::BigInt,
    }
    impl ValidatorCommissions {
        const METHOD_ID: [u8; 4] = [179u8, 184u8, 106u8, 84u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn output_call(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<((Vec<u8>, substreams::scalar::BigInt), bool), String> {
            Self::output(call.return_data.as_ref())
        }
        pub fn output(
            data: &[u8],
        ...
        pub fn call(
            &self,
            address: Vec<u8>,
        ) -> Option<((Vec<u8>, substreams::scalar::BigInt), bool)> {
            use substreams_ethereum::pb::eth::rpc;
            let rpc_calls = rpc::RpcCalls {
                calls: vec![rpc::RpcCall { to_addr : address, data : self.encode(), }],
            };
    ...
    impl substreams_ethereum::Function for ValidatorCommissions {
        const NAME: &'static str = "validatorCommissions";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<
        ((Vec<u8>, substreams::scalar::BigInt), bool),
    > for ValidatorCommissions {
        fn output(
            data: &[u8],
        ) -> Result<((Vec<u8>, substreams::scalar::BigInt), bool), String> {
            Self::output(data)
    ...
    pub struct ViewBalance {
        pub u_collection_address: Vec<u8>,
        pub u_token_id: substreams::scalar::BigInt,
        pub u_erc20_address: Vec<u8>,
    }
    impl ViewBalance {
        const METHOD_ID: [u8; 4] = [111u8, 158u8, 93u8, 71u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_erc20_address),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl substreams_ethereum::Function for ViewBalance {
        const NAME: &'static str = "viewBalance";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ViewWithdrawnAmount {
        pub u_collection_address: Vec<u8>,
        pub u_token_id: substreams::scalar::BigInt,
    }
    impl ViewWithdrawnAmount {
        const METHOD_ID: [u8; 4] = [203u8, 102u8, 15u8, 239u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for ViewWithdrawnAmount {
        const NAME: &'static str = "viewWithdrawnAmount";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl Withdraw {
        const METHOD_ID: [u8; 4] = [75u8, 32u8, 132u8, 227u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
...
pub mod events {
    ...
    pub struct Erc20Added {
        ...
        pub uri: String,
        pub total_balance: substreams::scalar::BigInt,
    }
    impl Erc20Added {
        const TOPIC_ID: [u8; 32] = [
            227u8,
    ...
    impl substreams_ethereum::Event for Erc20Added {
        const NAME: &'static str = "ERC20Added";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Event for Erc20Transferred {
        const NAME: &'static str = "ERC20Transferred";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PiNftBurnt {
        pub collection_address: Vec<u8>,
        pub token_id: substreams::scalar::BigInt,
        pub nft_reciever: Vec<u8>,
        pub erc20_receiver: Vec<u8>,
        pub erc20_contract: Vec<u8>,
        pub value: substreams::scalar::BigInt,
    }
    impl PiNftBurnt {
    ...
    impl substreams_ethereum::Event for PiNftBurnt {
        const NAME: &'static str = "PiNFTBurnt";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Event for PiNftRedeemed {
        const NAME: &'static str = "PiNFTRedeemed";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Event for ValidatorAdded {
        const NAME: &'static str = "ValidatorAdded";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ValidatorFundsRepayed {
        pub collection_address: Vec<u8>,
        pub repayer: Vec<u8>,
        pub token_id: substreams::scalar::BigInt,
        pub erc20_contract: Vec<u8>,
    ...
    impl substreams_ethereum::Event for ValidatorFundsRepayed {
        const NAME: &'static str = "ValidatorFundsRepayed";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ValidatorFundsWithdrawn {
        pub collection_address: Vec<u8>,
    ...
    impl substreams_ethereum::Event for ValidatorFundsWithdrawn {
        const NAME: &'static str = "ValidatorFundsWithdrawn";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
