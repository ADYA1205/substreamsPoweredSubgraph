...
pub mod functions {
    ...
    pub struct Initialize {
        pub u_name: String,
        pub u_symbol: String,
        pub u_pi_nf_tmethod_address: Vec<u8>,
    }
    impl Initialize {
        ...
        pub fn decode(
            ...
            Ok(Self {
                ...
                u_symbol: values
                    ...
                    .into_string()
                    .expect(INTERNAL_ERR),
                u_pi_nf_tmethod_address: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
            ...
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_pi_nf_tmethod_address),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct MintValidatedNft {
        pub u_to: Vec<u8>,
        pub u_uri: String,
    }
    impl MintValidatedNft {
        const METHOD_ID: [u8; 4] = [170u8, 239u8, 201u8, 226u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for MintValidatedNft {
        const NAME: &'static str = "mintValidatedNFT";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
